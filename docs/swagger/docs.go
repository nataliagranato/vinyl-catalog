    ...
    "paths": {
        ...
        "/vinyls": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.VinylResponse"
                            }
                        }
                    },
                    "500": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Dados do disco",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.CreateVinylRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.UpdateVinylRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/vinyls/{id}/cover": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Imagem da capa (jpg, png, webp)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        "http.CreateVinylRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Modal jazz masterpiece recorded in two sessions."
                },
                "genre": {
                    "type": "string",
                    "example": "Jazz"
        ...
        "http.VinylResponse": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Modal jazz masterpiece."
                },
                "genre": {
                    "type": "string",
                    "example": "Jazz"
